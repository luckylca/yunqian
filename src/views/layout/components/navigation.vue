...
<div class="container">
    ...
    <div class="user" v-else>
        <img id="img" src="data:image/png;base64," alt="">
        <div class="loginBox" id="loginBox" v-if="userSetting.language === 'zh-CN'" @click="router.push('/my')">lucky</div>
        <div class="loginBox" id="loginBox" v-else @click="router.push('/my')">lucky</div>
        <div class="registerBox" id="registerBox" v-if="userSetting.language === 'zh-CN'">退出</div>
        <div class="registerBox" id="registerBox" v-else>Logout</div>
    </div>
</div>
